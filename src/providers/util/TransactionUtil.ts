...
export class TransactionUtil {
  ...
  public static verifyAndEncodedSignTransaction(transaction: Transaction, rlpEncoded: Uint8Array, signature: Uint8Array, publicKey: Uint8Array) {
  ...
  public static rlpEncode(transaction: Transaction) { //return Uint8Array
